...
## 输出要求
1. **开头先写"本周看点"**：用 ## 标题，2-3 条核心洞察，概括本周最重要的趋势和关联
2. 然后按信息源分组，每组用 ## 标题标注来源
3. 每篇文章用 **加粗标题** + 2-3 句正文概括
4. 保留关键术语的英文原文（如 API、Kubernetes、LLM 等）
5. 突出"为什么这个重要"——技术意义或行业影响
6. 每篇附上原文链接，格式为 [原文链接](URL)
7. 不要用翻译腔，用自然流畅的中文表达
